...
def create_key(db: Session = Depends(get_db), owner_id: int = Depends(get_owner_id)):
...
def list_keys(db: Session = Depends(get_db), owner_id: int = Depends(get_owner_id)):
...
def revoke_key(key_id: int, db: Session = Depends(get_db), owner_id: int = Depends(get_owner_id)):
